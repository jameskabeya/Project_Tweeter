...
export default function OneTweet({ props }) {
    ...
    return (
        <div id="container_setting" className='flex border-b border-slate-800 p-4 mt-4 text-white'>
            <div className=''>
                <img className='h-13 w-24  rounded-full' src={user.profil} alt="image" />
            </div>
            <div className='ml-6 relative'>
                <h2 className="flex gap-3">{user.name}<img src="src/assets/Verified.svg" alt="" /><Small name={user.email} /></h2>
                <Paraph name={props.body} />
                {/* {
                    props.image && <img className='pt-2 rounded-3xl w-full object-cover h-60' src={props.thumbnailUrl} alt="Image" />
                } */}
                <img className='pt-2 rounded-3xl w-full object-cover h-60' src={props.thumbnailUrl} alt="Image" />
                <div className='flex pt-5 relative justify-between'>
                    <Myicoment viewBoxIcon="0 0 24 24" claces="fill-[#D9D9D9] hover:fill-blue-800 " name={props.id} >
                    ...
                    <Myicoment viewBoxIcon="0 0 24 24" claces="fill-[#D9D9D9] hover:fill-blue-800 " name={props.repost} >
